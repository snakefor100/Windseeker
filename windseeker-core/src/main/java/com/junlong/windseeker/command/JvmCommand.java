...
import com.junlong.windseeker.server.JvmEntity;
...
public class JvmCommand implements Command {
    ...
    public Action getAction() {
        return new Action.SlientAction() {
            @Override
            public void doAction(Instrumentation instrumentation) {
    ...
    private JvmEntity.RunTimeEntity getRunTimeEntity(JvmEntity jvmEntity) {
        ...
        runTimeInstance.setJvmStartTime(AppConstants.DATE_FORMAT.format(runtimeMXBean.getStartTime()));
